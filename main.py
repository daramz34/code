...
import crud
from schemas import Itemcreate, ItemReponse
...
@app.get("/items/", response_model=List[ItemReponse])
def get_item_routes(db:Session = Depends(get_db)):
    return crud.get_item(db=db)
